                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-end">{{ __('auth.confirm') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="idNumber"
                                    class="col-md-4 col-form-label text-md-end">{{ __('auth.idNumber') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="birthDate"
                                    class="col-md-4 col-form-label text-md-end">{{ __('auth.birthDate') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="phoneNumber"
                                    class="col-md-4 col-form-label text-md-end">{{ __('auth.phoneNumber') }}</label>
